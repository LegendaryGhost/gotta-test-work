                                    ...
                                    <div class="modal-body">
                                        <form method="GET" action="ingredient">
                                            <div class="mb-3">
                                                ...
                                                <input name="searchName" type="text" class="form-control" id="search-name" placeholder="Nom" aria-label="Nom" aria-describedby="search-name">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="search-unit">Unité de mesure</label>
                                                <input name="searchUnit" type="text" class="form-control" id="search-unit" placeholder="Unité de mesure" aria-label="Unité de mesure" aria-describedby="search-unit">
                                            </div>
                                            <div class="row g-2 mb-3">
                                                <div class="col mb-0">
                                                    <label class="form-label" for="search-min-price">Prix minimum</label>
                                                    <input name="searchMinPrice" min="1" type="number" class="form-control" id="search-min-price" placeholder="Prix" aria-label="Prix" aria-describedby="search-min-price">
                                                </div>
                                                <div class="col mb-0">
                                                    <label class="form-label" for="search-max-price">Prix maximum</label>
                                                    <input name="searchMaxPrice" min="1" type="number" class="form-control" id="search-max-price" placeholder="Prix" aria-label="Prix" aria-describedby="search-max-price">
                                                </div>
                                            </div>
